...
void ViewManager::Scroll_Callback(GLFWwindow* window, double xoffset, double yoffset) {
	...
	if (g_pCamera->MovementSpeed > 120.0f)
		g_pCamera->MovementSpeed = 120.0f;
}
...
void ViewManager::PrepareSceneView()
{
	...
	else
	{
		...
		//projection = glm::ortho((WINDOW_WIDTH / 2.0f), (WINDOW_WIDTH / 2.0f), (WINDOW_HEIGHT / 2.0f), (WINDOW_HEIGHT / 2.0f), 0.1f, 100.f);
	}
